...
Statement stmt;
int floor=2;
String dpt="0000-00-00 00:00:00";
...
%>
<%String sql = "SELECT user.Name,user.Phone,car.Registration_No,car.car_type,car.model,parking_space.floor,parking_space.parking_Slot,parking_transactions.Arrival_Time FROM parking_transactions Join user on parking_transactions.user_idUser=user.idUser Join car on parking_transactions.Car_IdCar=car.idCar join parking_space on parking_transactions.Parking_space_idParking_space=parking_space.idparking_space where parking_space.floor='"+floor+"'and parking_slot='"+a+"' and departure_time='"+dpt+"'";
try {
...
out.write("<thead><tr>");
out.write("<th>Owner's Name</th><th>Phone No</th><th>Registration_No</th><th>Car_type</th><th>Model</th><th>Floor</th><th>Parking_Slot</th><th>Arrival_Time</th>");
