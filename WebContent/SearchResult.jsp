...
<% String regNo=(String) request.getAttribute("reg");   %>
<body>
<div class="container-fluid">
		...
		<div class="row">
			...
			<caption><center><h1 id=mainTitle>Search Result</h1></center></caption>
<%
String driver;
String url;
...
%>
<%String sql = "SELECT user.Name,user.phone,user.email,car.Registration_No,car.car_type,car.model,parking_space.floor,parking_space.parking_Slot,parking_space.status,parking_transactions.Arrival_Time,parking_transactions.departure_time FROM parking_transactions Join user on parking_transactions.user_idUser=user.idUser Join car on parking_transactions.Car_IdCar=car.idCar join parking_space on parking_transactions.Parking_space_idParking_space=parking_space.idparking_space Where car.Registration_No='"+regNo+"' ";
try {
...
out.write("<thead><tr>");
out.write("<th>Name</th><th>Phone</th><th>Email</th><th>Registration_No</th><th>Car_type</th><th>Model</th><th>Floor</th><th>Parking_Slot</th><th>Status</th><th>Arrival_Time</th><th>Departure_Time</th>");
