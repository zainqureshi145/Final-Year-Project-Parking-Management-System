...
<div class="container-fluid">
		...
		<div class="row">
			...
			<caption><center><h1 id=mainTitle>Cars</h1></center></caption>
<%
String driver;
String url;
...
%>
<%String sql = "Select * from pms.car";
try {
