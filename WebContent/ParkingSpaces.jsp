...
<div class="container-fluid">
		...
		<div class="row">
			...
			<caption><center><h1 id=mainTitle>Total Parking Spaces</h1></center></caption>
<%
String driver;
String url;
...
%>
<%String sql = "Select * from pms.parking_space";
try {
...
out.write("<thead><tr>");
out.write("<th>Parking_Space_ID</th><th>Floor</th><th>Parking_Slot</th><th>Status</th>");
out.write("</thead><tbody>");
try {
	while(rs.next()){
		out.write("<tr>");
		out.write("<td>"+rs.getInt("idParking_Space")+"</td>");
