...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<form action="InsertCarServlet" method="post" onsubmit="return validate()">
				<table>
					<br>
					<tr>
						<td>
					...
					<tr>
						<td>
						<input type="text" name="carid" id="a" class="form-control field">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<input type="text" name="regno" id="b" class="form-control field">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<input type="text" name="ctype" id="c" class="form-control field">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<input type="text" name="model" id="d" class="form-control field">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
						<input type="text" name="uid" id="e" class="form-control field">
						</td>
					</tr>
