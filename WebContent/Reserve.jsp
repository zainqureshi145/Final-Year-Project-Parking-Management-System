...
<div class="container-fluid">
		...
		<div class="row">
			...
			<caption><center><h1 id=mainTitle>Users</h1></center></caption>
<%
String driver;
String url;
...
%>
<%String sql = "Select * from pms.reserve";
try {
...
out.write("<html>");
out.write("<head><title>Reserve ResultSet</title></head>");
out.write("<body>");
