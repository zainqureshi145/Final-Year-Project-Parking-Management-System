...
<head>
	...
	<div class="container">
		...
		<div class="row">
			...
			<button class="btn btn-primary" name="button2" value="2" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button3" value="3" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button4" value="4" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button5" value="5" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
		...
		<div class="row">
			...
			<button class="btn btn-primary" name="button21" value="1" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button22" value="2" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button23" value="3" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button24" value="4" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
			...
			<button class="btn btn-primary" name="button25" value="5" onclick="{hdnbt.value=this.value;}"  >Show Info</button>
			<div>
