...
out.write("<thead><tr>");
out.write("<th>IdUser</th><th>Name</th><th>Email</th><th>Phone</th><th>Premium_User</th><th>Parking_Space_ID</th>");
//out.write("<tr><td>idCar</td><td>Registration_No</td><td>Car_Type</td><td>Model</td><td>User_idUser</td></tr>");
out.write("</thead> <tbody>");
try {
	while(rs.next()){
		out.write("<tr>");
		out.write("<td>"+rs.getInt("idUser")+"</td>");
		out.write("<td>"+rs.getString("Name")+"</td>");
		out.write("<td>"+rs.getString("Email")+"</td>");
		out.write("<td>"+rs.getString("Phone")+"</td>");
		out.write("<td>"+rs.getString("Premium_user")+"</td>");
		out.write("<td>"+rs.getInt("Parking_Space_idParking_Space")+"</td>");
		out.write("</tr>");
		out.write("</tbody>");
